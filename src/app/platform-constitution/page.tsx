    ...
    <div className="min-h-screen bg-black text-white selection:bg-indigo-500">
      ...
      <main className="mx-auto max-w-4xl px-8 py-16 text-white/90">
        <header className="space-y-6 mb-12">
          <h1 className="text-5xl font-black uppercase tracking-[0.1em] bg-clip-text text-transparent bg-gradient-to-r from-[#00d4ff] via-[#6a5cff] via-[#ff4fd8] to-[#ff8a00] drop-shadow-[0_0_25px_rgba(106,92,255,0.6)] brightness-125">
