  ...
  return (
    <section className="relative overflow-hidden border-b border-white/10 bg-black">
      ...
      <div className="relative mx-auto max-w-7xl px-8 py-20 md:py-28 text-left">
        ...
        <h1 className="mt-8 max-w-4xl text-5xl font-black leading-tight md:text-7xl uppercase tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-[#00d4ff] via-[#6a5cff] via-[#ff4fd8] to-[#ff8a00] drop-shadow-[0_0_25px_rgba(106,92,255,0.6)] brightness-125">
